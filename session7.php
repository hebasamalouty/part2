...
if(count($errors) > 0){
   ...
   $sql= "insert into blog (Title,Content,Date,Image) values('$BlogTitle','$Content','$Date','$finalName')";
...
<!DOCTYPE html>
<html>
    <form action="session7.php" <?php htmlspecialchars($_SERVER['PHP_SELF']); ?> method="post" enctype="multipart/form-data">
        <div>
        <label> Title </title>
    <input type="text" name="title" size="50" placeHolder="Write the title">
        ...
        <div>
        <label> Date </title>
    <input type="date" name="date" size="50" placeHolder="Write the date">
        </div>
        <br> 
        <br>
        <div>
